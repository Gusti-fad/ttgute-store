        ...
        <section id="contact" className="grid grid-cols-2 md:px-40 md:py-12 px-5 py-5">
            ...
            <div>
                ...
                <div className="my-5">
                    ...
                    <input type="submit" name="submit" id="submit" value={"Send Message"} className="w-full h-full mt-5 py-2 px-7 border-2 border-[#130f40] text-[17px] rounded-r-full rounded-bl-full leading-normal" />
                </div>
            </div>
        </section>
    );
